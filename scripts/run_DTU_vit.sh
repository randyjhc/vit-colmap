...
OUTPUT_DIR="data/outputs/DTU/${SCAN_NAME}_vit"
DB_PATH="data/intermediate/DTU/${SCAN_NAME}/vit_database.db"
...
echo "Running COLMAP pipeline with ViT on DTU ${SCAN_NAME}..."
